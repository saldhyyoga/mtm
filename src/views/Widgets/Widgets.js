    ...
    return (
      <div className="animated fadeIn">
        ...
        <Row>
          ...
          <Col xs="12" sm="6" lg="4">
            <Widget02 header="123 Transaction" mainText="Card Number Transaction" icon="fa fa-credit-card" color="primary" footer link="#/charts" />
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Widget02 header="$1.999,50" mainText="Card Pending Transaction" icon="fa fa-exclamation" color="warning" footer />
          </Col>
          <Col xs="12" sm="6" lg="4">
            <Widget02 header="$1.999,50" mainText="Card Failed Transaction" icon="fa fa-trash" color="danger" footer />
          </Col>
        </Row>
        <Row>
          <Col xs="12" sm="6" lg="3">
            <Widget02 header="$1.999,50" mainText="Income test" icon="fa fa-cogs" color="primary" variant="1" />
          </Col>
          <Col xs="12" sm="6" lg="3">
